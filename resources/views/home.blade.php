 ...
 <header class="tm-header" id="tm-header">
     <div class="tm-header-wrapper">
         ...
         <div class="tm-site-header">
             <div class="mb-3 mx-auto tm-site-logo"><i class="fas fa-blog fa-2x "></i></i></div>
 ...
 <div class="container-fluid">
     <main class="tm-main">
         ...
         <div class="row tm-row">
             <div class="col-12">
                 <form method="GET" class="form-inline tm-mb-80 tm-search-form" action="{{route('home')}}">
                     <input class="form-control tm-search-input" name="query" value="#"type="text" placeholder="Search..."
                         aria-label="Search">
         ...
         <div class="list">
             <table class="nav">
                 <tr class="size">
                     <th style="padding:10px 50px; line-">Blog</th>
                     <th style="padding:10px 50px;">Post By</th>
                     <th style="padding:10px 50px;">Time</th>
